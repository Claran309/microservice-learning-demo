...
import (
	...
	"microservicesDemo/L5-kafka/internal/user-service/handler"
	"microservicesDemo/L5-kafka/internal/user-service/service"
	"microservicesDemo/L5-kafka/kitex_gen/user/userservice"
